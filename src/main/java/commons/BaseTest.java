...
public class BaseTest {
	...
	public static synchronized ExtentTest logExtentV5(String value) {
		return ExtentTestManager.getTest().log(Status.INFO, value);
	}

	public static synchronized ExtentTest logStartTest(String testName, String desc) {
		return ExtentTestManager.startTest(testName, desc);
	}
