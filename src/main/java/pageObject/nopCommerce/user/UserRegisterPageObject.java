...
public class UserRegisterPageObject extends BasePage {
	...
	public void selectDropdownDay(String day) {
		waitForElementClickable(driver, RegisterPageUI.DROPDOWN_DAY);
		selectItemInDefaulfDropdown(driver, RegisterPageUI.DROPDOWN_DAY, day);
	}

	public void selectDropdownMonth(String month) {
		waitForElementClickable(driver, RegisterPageUI.DROPDOWN_MONTH);
		selectItemInDefaulfDropdown(driver, RegisterPageUI.DROPDOWN_MONTH, month);
	}

	public void selectDropdownYear(String year) {
		waitForElementClickable(driver, RegisterPageUI.DROPDOWN_YEAR);
		selectItemInDefaulfDropdown(driver, RegisterPageUI.DROPDOWN_YEAR, year);
	}
