...
public class CustomerInfoPageUI {
	...
	public static final String NEWSLETTER_LINK = "XPATH=//input[@id='Newsletter']";
	...
	public static final String NOTIFICATION_SUCCESS_TEXT_AT_CUSTOMERINFO = "//div[@class='bar-notification success']";
