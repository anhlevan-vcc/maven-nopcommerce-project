...
public class RegisterPageUI {
	...
	public static final String DROPDOWN_DAY = "//select[@name='DateOfBirthDay']";
	public static final String DROPDOWN_MONTH = "//select[@name='DateOfBirthMonth']";
	public static final String DROPDOWN_YEAR = "//select[@name='DateOfBirthYear']";
